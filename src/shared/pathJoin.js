...
// 기준 경로: D:\cutie-patootie\src\shared 기준으로 프로젝트 루트 계산
const rootDir = path.resolve(__dirname, "..", "..");

// src/main 디렉토리 경로 반환
function getMainPath() { return path.join(rootDir, "src", "main"); }

// src/module 디렉토리 경로 반환
function getModulePath() { return path.join(rootDir, "src", "module"); }

// src/renderer 디렉토리 경로 반환
function getRenderPath() { return path.join(rootDir, "src", "renderer"); }

// src/renderer/asset 디렉토리 경로 반환
function getAssetPath() { return path.join(rootDir, "src", "renderer", "asset"); }
